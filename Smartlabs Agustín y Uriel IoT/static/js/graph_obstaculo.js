...
function updateChart() {
    ...
    .then(data => {
        ...
        if (data.obstacle !== undefined) {
            ...
            myChart.data.datasets[0].data.push({ x: currentTime, y: data.obstacle }); // Agregar punto
            myChart.data.datasets[1].data.push({ x: currentTime, y: data.obstacle }); // Agregar punto a la línea
            ...
            console.log(`Data point added: ${currentTime} ms, ${data.obstacle}`);
        } else {
